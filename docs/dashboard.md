...
## 13. Capturas de ejemplo

### Estado inicial
```
📊 Dashboard de Scraping - Monitoreo en Tiempo Real
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Estado de Conexión: 🟢 Conectado

┌──────────────┬─────────────────┬────────────────┬──────────┬──────────┐
│ SITIO ACTUAL │ URLS ENCONTRADAS│ ARTS. EXITOSOS │ ERRORES  │VELOCIDAD │
│ BioBio Chile │       450       │      268       │    0     │  65.2    │
│Medio en scra │ Por el crawler  │  Scrapeados    │Fallos en │artículos/│
│     ping     │                 │ correctamente  │ scraping │   min    │
└──────────────┴─────────────────┴────────────────┴──────────┴──────────┘

Progreso del Crawler
[████████████░░░░░░░░░░░░░░░░░░░░] 33.3%
Crawler en proceso... | 26 de 78 categorías procesadas

📈 Noticias Scrapeadas en Tiempo Real
[Gráfico con línea verde ascendente]
```
...
SITIO ACTUAL: BioBio Chile
URLS ENCONTRADAS: 450
ARTÍCULOS EXITOSOS: 450
ERRORES: 0
VELOCIDAD: 154.4 artículos/min

Progreso del Crawler
[████████████████████████████████] 100%
✅ Crawler completado | 78 de 78 categorías procesadas
```
