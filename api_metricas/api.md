...
```
[http://192.168.1.45:8000/docs](http://192.168.1.45:8000/docs)
```

y acceder directamente a las métricas en:

```
[http://192.168.1.45:8000/api/metrics/](http://192.168.1.45:8000/api/metrics/)
```
...
```bash
curl -sSL [https://ngrok-agent.s3.amazonaws.com/ngrok.asc](https://ngrok-agent.s3.amazonaws.com/ngrok.asc)  | sudo tee /etc/apt/trusted.gpg.d/ngrok.asc >/dev/null  && echo "deb [https://ngrok-agent.s3.amazonaws.com](https://ngrok-agent.s3.amazonaws.com) bookworm main"  | sudo tee /etc/apt/sources.list.d/ngrok.list  && sudo apt update  && sudo apt install ngrok
```
...
```
Forwarding  [https://random-id.ngrok-free.dev](https://random-id.ngrok-free.dev) -> http://localhost:8000
```
...
```
[https://random-id.ngrok-free.dev](https://random-id.ngrok-free.dev)
```
...
5.  Render desplegará la API y entregará una URL pública, por ejemplo:
    ...
    ```
    [https://api-metricas-sophia.onrender.com](https://api-metricas-sophia.onrender.com)
    ```
...
```bash
curl [http://127.0.0.1:8000/api/metrics/](http://127.0.0.1:8000/api/metrics/)
```

Para visualizar la respuesta con formato legible:

```bash
curl [http://127.0.0.1:8000/api/metrics/](http://127.0.0.1:8000/api/metrics/) | jq
```
...
```js
fetch("[http://192.168.1.45:8000/api/metrics/](http://192.168.1.45:8000/api/metrics/)")
  .then(res => res.json())
  .then(data => {
